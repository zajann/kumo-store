<template>
  ...
  <div class="container w-75">
    ...
    <h4 style="font-weight: bold; margin-top: 80px; color: #3d3d3d">오프라인 스토어</h4>
    <hr class="hr-short">
    ...
    <b-container class="">
      ...
      <b-row style="height: 600px; border: 1px solid #ccc;">

        <b-col cols=12 lg="4" class="h-100 w-100 d-none d-lg-block d-xl-block" style="">
          <b-container class="w-100 h-100">
            <b-row class="h-25" style="">
              <b-tabs active-nav-item-class="bg-secondary" pills fill class="w-100" style="margin-top: 10px;">
                <b-tab title="지역별 검색">
                  <b-container>
                    <b-row style="margin-top: 10px;">
                      <b-col cols=4>
                        <b-form-select 
                           class="frmVal" 
                           style="font-size: 13px; margin-left: -5px; width:100%"
                      ...
                      <b-col cols=6>
                        <b-form-input 
                           ...
                           style="font-size: 13px; margin-left: -10px; width:120%"
            ...
            <b-row class="h-75">
              <div class="w-100" style="max-height: 445px; overflow: auto;">
                <b-table
                   :items="table_items" 
                   :fields="table_fields"
        ...
        <b-col cols=12 lg="8" style="height: 100%;">

          <div class="w-100 h-100" style="margin-top: 1px;">
            <naver-maps
  ...
  computed: {
    drawTable () {
      ...
      for (let i = 0; i < stores.length; i ++) {
        ...
        let markerStr = `<img style="margin-top: 20px;" src="../../static/img/marker.png"></img>`;
  ...
  methods: {
    searchStoreByRegion () {
      ...
      this.$http.get('/api/stores/region', {
        ...
        if (this.show_store_info.length != 0 ) {
          this.map.setCenter(this.show_store_info[0].lat, this.show_store_info[0].lng);
        }
    ...
    onMarkerClicked(event) {
      ...
      let infoWindowHTML = 
        `<div style="text-align: left; margin: 20px;">
          ...
          <a href="${marker_store.web_link}">
          <img style="width: 30px; height: 30px;"src="../../static/img/naver_conn.png"></img>
          </a>
          </p>
        </div>`;
